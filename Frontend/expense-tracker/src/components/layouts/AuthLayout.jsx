import CARD_2 from '../../assets/images/image2.jpg'
  ...
  return (
    <div className='flex'>
        ...
        <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
            ...
            <img src={CARD_2} alt="charts image" className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15 rounded-e-2xl' />
        </div>
    </div>
  )
}
...
const StatsIconCard = ({icon,label,value,color}) =>{
    return (
